...
/* Tipos de datos */
( byte | Caracters | Nlargo | float | Doble ) {return new Symbol(sym.T_dato, yychar, yyline, yytext());}
...
( Otrocaso ) {return new Symbol(sym.Else, yychar, yyline, yytext());}
...
( verdad | falso ) {return new Symbol(sym.Op_booleano, yychar, yyline, yytext());}
